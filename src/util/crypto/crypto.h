...
public:
	...
	void hash_hw(void * hdev, uint8_t* resbuf, uint32_t noutbytes, uint8_t* inbuf, uint32_t ninbytes, uint8_t* tmpbuf);
...
public:
	...
	int sm2_set_pow(void * hdev, cap_ecc_prikey_t * k, cap_ecc_pubkey_t * p, cap_ecc_pubkey_t * q);
